...
REM
REM Generated by Vivado on Tue Dec 02 20:40:57 -0800 2025
...
echo "xvlog --incr --relax -prj tb_cpu2_vlog.prj"
call xvlog  --incr --relax -prj tb_cpu2_vlog.prj -log xvlog.log
