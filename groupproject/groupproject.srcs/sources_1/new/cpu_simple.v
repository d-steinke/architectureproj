...
//////////////////////////////////////////////////////////////////////////////////
// Module: cpu_simple
// CPU variant that uses im_simple for basic testing
//////////////////////////////////////////////////////////////////////////////////
...
module cpu_simple (
    ...
    // Instruction memory (use simple version)
    wire [31:0] if_instr;
    im_simple IF_IMEM_INST (
        .address(if_pc),
